<footer class="bg-gray-900 text-gray-400 pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 pb-12 border-b border-gray-800">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <p class="text-sm text-gray-500 leading-relaxed max-w-xs">
                    AI-powered FTTH fiber audit platform for network quality analysis and compliance.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="#product-preview" class="text-sm hover:text-white transition-colors">Demo</a></li>
                    <li><a href="{{ route('register') }}" class="text-sm hover:text-white transition-colors">Get Started</a></li>
                </ul>
            </div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4 pt-8">
            <p class="text-sm text-gray-500">
                &copy; {{ date('Y') }} {{ config('app.name', 'FiberFlow') }}. All rights reserved.
            </p>
            <div class="flex items-center gap-5">
                ...
                {{-- GitHub --}}
                <a href="#" class="text-gray-500 hover:text-white transition-colors" aria-label="GitHub">
